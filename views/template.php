...
<div style="background-color:rgba(45,45,85,1); color:white; font-weight:600;">
    <div class="container" style="height:75px;">
        ...
        <li><a href="#!/" onclick="changePanel(1)"><span class="valign-wrapper"><i class="material-icons">toc</i>Liste des projets</span></a></li>
        <li><a href="#!/contenu_projet" ng-click="getPath('equipement');"><span class="valign-wrapper"><i class="material-icons">markunread_mailbox</i>Gestion des contenus d'un projet</span></a></li>
