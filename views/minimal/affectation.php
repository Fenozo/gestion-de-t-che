        ...
        <div style="position:relative; height:520px;">
            ...
            <div class="row">
                ...
                <div class="col s9" style="padding:0px 3px; font-size:14px; border-left:1px solid #e1e1e1; height:350px; position:relative;">
                    <div class="card">
                        <div class="waves-effect waves-block waves-light" style="height:275px; overflow: scroll; padding:7px 35px;">
                            ...
                            <ul style="padding-top:7px;" ng-show="affectations_1">
                                 ...
                                 <div class="col s12">
                                    <table class="striped">
                                        ...
                                        <tbody >
                                            <tr ng-show="afficher_affectation" ng-repeat="equipement in affected">
                                                <td>{{equipement.marque}} {{equipement.modele}}</td>
                                                <td>{{equipement.numero_serie}} </td>
                                                <td>{{getEtatEquipement(equipement.etat)}}</td>
                                                <td class="enlever" ng-click="valider_affectation(equipement)">-</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="card-reveal">
                            ...
                            <div ng-show="affectations_3" >
                                <button ng-click="valider_affectation()" class="btn waves-effect waves-light" type="submit" name="action">Valider une affectation
